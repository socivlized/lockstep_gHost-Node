...
  Trigger Breach Lockdown if threshold exceeded  
...
regime_k = classify(R_k, Φ_k) → {Stable Coherence | Adaptive Exploration | Intensive Reasoning | Breach Lockdown}  
...
## VI. Safety Envelope & Breach Lockdown
...
- **Breach Lockdown**: Critical breach — immediate halt + recovery.

Breach Lockdown triggers vector clamping, energy deduction, and optional rollback.
...
| Breach Lockdown         | ≥ 0.95      | ≤ 0.10      | ≥ 0.90      | Unconstrained (with halt)           | Minimal (critical)    |
